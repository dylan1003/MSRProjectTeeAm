...
SELECT BulkColumn
From openrowset ( Bulk 'C:\Users\WorkStation\source\repos\MSR_Spike_Test_DB\Images\THE-POPPY.jpg', Single_Blob) as img;
...
INSERT INTO  MultiMedias(Media)
SELECT BulkColumn
From openrowset ( Bulk 'C:\Users\STUDENT\source\repos\MSR_Spike_Test_DB\Images\ShowImage.jpg', Single_Blob) as Media;
...
INSERT INTO  MultiMedias(Media)
SELECT BulkColumn
From openrowset ( Bulk 'C:\Users\STUDENT\source\repos\MSR_Spike_Test_DB\Images\Existence_01.jpg', Single_Blob) as Media;
...
/*Select Convert(varchar(MAX), Media) from MultiMedias where id = 1;*/ 
